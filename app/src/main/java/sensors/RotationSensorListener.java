...
/*
public class RotationSensorListener extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSensorAccelerometer = mSensorManager != null ? mSensorManager.getDefaultSensor(
                Sensor.TYPE_ACCELEROMETER) : null;
        mSensorMagnetometer = mSensorManager != null ? mSensorManager.getDefaultSensor(
                Sensor.TYPE_MAGNETIC_FIELD) : null;

        // Get the display from the window manager (for rotation).
        WindowManager wm = (WindowManager) getSystemService(WINDOW_SERVICE);
        mDisplay = wm != null ? wm.getDefaultDisplay() : null;
    }
